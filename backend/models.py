...
class Email(Base):
    ...
    interview_invitation = relationship("InterviewInvitation", back_populates="email", uselist=False)
...
class DraftReply(Base):
    ...
    interview_invitation = relationship("InterviewInvitation", back_populates="draft_replies")
